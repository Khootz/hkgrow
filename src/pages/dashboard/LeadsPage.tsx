...
export default function LeadsPage() {
  ...
  const testConnection = async () => {
    const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://hkgrow-kfk645pdo-thiens-projects-80bfe1b8.vercel.app';
...
Backend: ${API_BASE_URL}`;
  ...
  const handleDownloadCSV = () => {
    if (extractionResult?.data?.filename) {
      ...
      const downloadUrl = `${import.meta.env.VITE_API_URL || 'https://hkgrow-kfk645pdo-thiens-projects-80bfe1b8.vercel.app'}/api/download/${extractionResult.data.filename.split('/').pop()}`;
